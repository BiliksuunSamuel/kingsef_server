...
function default_1(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const data = yield (0, UserServices_1.GetUserByEmail)(info.email);
            yield (0, UserServices_1.ResendOTP)(info.email);
            ...
            res.send(yield (0, UserServices_1.GetUserByEmail)(info.email));
        }
        catch (error) {
            console.log(error);
