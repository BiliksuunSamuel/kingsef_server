...
exports.UpdatePackagingOrderInfo = exports.GetDebitsPayments = exports.AddDebitPayment = exports.DeleteHelpCenterMessage = exports.UpdateChatMessageSeen = exports.GetHelpCenterChats = exports.SaveHelpCenterChat = exports.PackageFavorites = exports.PackageLike = exports.GetPackageById = exports.UpdatePackageQuantity = exports.GetPackageOrders = exports.AddPackageOrder = exports.GetPackages = exports.AddPackage = exports.UpdateDisplayCat = exports.GetDisplayCatById = exports.GetDisplayCats = exports.AddDisplayCat = exports.GetReviews = exports.AddReview = exports.GetAdverts = exports.AddAdvert = exports.AddNotification = exports.GetDeliveryPricingByISOCode = exports.GetDeliveryPricings = exports.DeleteDisplayCatInfo = exports.UpdateDisplayCatInfo = exports.AddDeliveryPricing = void 0;
...
function DeleteDisplayCatInfo(id) {
    return new Promise(function (resolve, reject) {
        try {
            Model_1.DisplayCatModel.deleteOne({ _id: id }, (error) => {
                error && reject(error);
                resolve(true);
            });
        }
...
exports.DeleteDisplayCatInfo = DeleteDisplayCatInfo;
